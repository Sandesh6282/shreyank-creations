    ...
    >
      ...
      <div className="relative aspect-square w-full bg-sand-light/50 overflow-hidden">
        ...
        <div className="absolute inset-x-3 bottom-3 opacity-0 group-hover:opacity-100 transition-all duration-300 flex gap-2 z-10">
          <button
            ...
            className="flex-1 bg-espresso/90 hover:bg-terracotta text-cream text-xs font-semibold py-2.5 px-3 rounded-lg backdrop-blur-xs transition-colors flex items-center justify-center gap-1.5 shadow-md"
          >
          ...
          <Link
            ...
            className="p-2.5 bg-cream-surface/90 hover:bg-cream text-espresso rounded-lg backdrop-blur-xs transition-colors flex items-center justify-center shadow-md"
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="mt-auto pt-2 flex items-center justify-between border-t border-sand/30">
          ...
          <button
            onClick={() => addToCart(product, 1)}
            className="md:hidden p-2 text-terracotta hover:bg-terracotta hover:text-cream rounded-full transition-colors"
